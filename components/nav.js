        ...
        <div class="flex flex-wrap items-center justify-between">
            ...
            <div class="cart-items flex flex-wrap items-center">
                ...
                <div class="user-ops absolute top-[64px] right-0 w-[250px] bg-slate-200 pl-4 pr-4 pb-4 pt-2 rounded-md border border-stone-500" id="user-list">
                    <div class="user mt-1" id="userinfo">
                    </div>
                    <div class="input flex text-center">
                        <button class="mx-2 text-sm px-1 py-2 w-full bg-myblue m-3 rounded-md text-white" id="signup"><a href="/pages/signup.html">Sign Up</a></button>
                        <button class="mx-2 text-sm px-1 py-2 w-full bg-myblue m-3 rounded-md text-white" id="signin"><a href="/pages/signin.html">Sign In</a></button>
                        <button class="mx-2 text-sm px-1 py-2 w-full bg-myblue m-3 rounded-md text-white hidden" id="signout"><a href="">Sign Out</a></button>
                    </div>
                    <div class="list">
                        <ul class="ml-2">
