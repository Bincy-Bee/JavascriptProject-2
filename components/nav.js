        ...
        <div class="flex flex-wrap items-center justify-between">
            ...
            <nav>
                <ul class="flex font-normal">
                    ...
                    <li><a href="../pages/about.html" class="mx-1 text-myblue py-1 px-4 hover:bg-slate-50 rounded-2xl font-medium hover:drop-shadow-md">About</a></li>
                </ul>
            </nav>
            <div class="cart-items flex flex-wrap items-center">
            <button><a href="../pages/cart.html"><i class="fa-solid fa-cart-shopping mx-1 text-xl text-myblue hover:text-black px-2 rounded-full p-1 hover:bg-slate-50"></i></a></button>
